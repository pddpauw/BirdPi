...
wget -P $HOME/BirdNET-Pi/model https://github.com/pddpauw/BirdPi/raw/5dc2a1edec6f669f8baff06be08b6cc996db36a2/model/BirdNET_GLOBAL_6K_V2.4_MData_Model_V2_FP16%20(1).tflite
...
mv $HOME/BirdNET-Pi/model/BirdNET_GLOBAL_6K_V2.4_MData_Model_V2_FP16%20(1).tflite $HOME/BirdNET-Pi/model/BirdNET_GLOBAL_6K_V2.4_MData_Model_FP16.tflite
