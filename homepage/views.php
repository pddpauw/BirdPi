...
if(isset($_GET['view'])){
    ...
    if (!isset($_SERVER['PHP_AUTH_USER'])) {
      ...
      if($submittedpwd == $caddypwd && $submitteduser == 'birdnet'){
        ...
        echo "<div class=\"centered\">
          ...
          <button type=\"submit\" name=\"view\" value=\"Backups\" form=\"views\">Backups Manager</button>
  ...
  if($_GET['view'] == "Backups"){include('scripts/backups.php');}
  ...
  if (!isset($_SERVER['PHP_AUTH_USER'])) {
    ...
    $allowedCommands = array('sudo systemctl stop livestream.service && sudo /etc/init.d/icecast2 stop',
                       ...
                       'sudo systemctl disable --now rclone.service',
