...
# HIER table_rows = cursor.fetchall()
...
# OLD f, axs = plt.subplots(1, 2, figsize=(10, 4), gridspec_kw=dict(width_ratios=[3, 6]), facecolor='#77C487')
...
plt.suptitle("Top 100 observations today, last update: " + str(now.strftime("%Y-%m-%d %H:%M")))
