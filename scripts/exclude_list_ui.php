...
<div class="customlabels smaller">
  <button type="submit" name="view" value="UI_Excluded" form="add">>>ADD>></button>
</div>
</div>
...
<div class="customlabels column2">
  ...
  <button type="submit" name="view" value="UI_Excluded" form="add">>>ADD>></button>
  <br><br>
  <button type="submit" name="view" value="UI_Excluded" form="del">REMOVE</button>
  </td></table>
</div>
...
<?php
  $filename = './scripts/exclude_species_list_ui.txt';
  $eachline = file($filename, FILE_IGNORE_NEW_LINES);
